...
class TrashGameScreen extends GameScreen {
    constructor(game) {
        super(game);
        this._game = game;
        this.talker = null;
    ...
    create() {
        ...
        this.gameController = new TrashGame(this.game);
        ...
        this.tut01 = this.game.add.sprite(this.game.world.centerX, this.game.world.centerY - 20, "2-6-3-01");
        this.tut01.anchor.set(0.5);
        this.tut01.visible = false;
        this.tut02 = this.game.add.sprite(this.game.world.centerX, this.game.world.centerY - 20, "2-6-3-02");
        this.tut02.anchor.set(0.5);
        this.tut02.visible = false;
        this.tut03 = this.game.add.sprite(this.game.world.centerX, this.game.world.centerY - 20, "2-6-3-03");
        this.tut03.anchor.set(0.5);
        this.tut03.visible = false;
        this.tut04 = this.game.add.sprite(this.game.world.centerX, this.game.world.centerY - 20, "2-6-3-04");
        this.tut04.anchor.set(0.5);
        this.tut04.visible = false;
        this.tut05 = this.game.add.sprite(this.game.world.centerX, this.game.world.centerY - 20, "2-6-3-05");
        this.tut05.anchor.set(0.5);
        this.tut05.visible = false;

        this.talker.loadTalkingArray(TALKING_DATA.talkingdata.TrashSelector_Prolog);
    ...
    EndGame_OnRetryButtonDown() {
        this.game.state.start("TrashGameScreen");
    }

    onGameWin(score) {
        this.talker.loadTalkingArray(TALKING_DATA.talkingdata.TrashSelector_End);
        this.talker.startTalk();
    }

    onGameLose(score) {
        this.talker.loadTalkingArray(TALKING_DATA.talkingdata.TrashSelector_Fail);
        this.talker.startTalk();
    }
