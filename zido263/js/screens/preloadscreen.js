class PreloadScreen {
    ...
    preload() {
        ...
        TALKING_DATA.loadAudios(game, TALKING_DATA.talkingdata.TrashSelector_Prolog);
        TALKING_DATA.loadAudios(game, TALKING_DATA.talkingdata.TrashSelector_End);
        TALKING_DATA.loadAudios(game, TALKING_DATA.talkingdata.TrashSelector_Fail);
