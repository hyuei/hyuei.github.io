Endscreen = function(x, y){
	...
	this.resultText = game.add.sprite(0, 0, 'ingame');
	this.resultText.frameName = 'ingame/congrats-title';
	...
	this.charas = [];
	for(var a = 0; a < 3; a++){
		var chara = game.add.sprite(0, this.resultText.y - (this.resultText.height * 0.25), 'ingame');
		chara.frameName = 'ingame/' + names[a];
	...
	this.scoreBox = game.add.sprite(0, this.bg.y + (this.bg.height * 0.14), 'ingame');
	this.scoreBox.frameName = 'ingame/scorebox';
