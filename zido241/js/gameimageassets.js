class GameImageAssets extends ImageAssetsData
{
    constructor()
    {
        ...
        [   
            ...
            {id:"sammi-think", file:"assets/images/sammi-think.png"},
            ...
            {id:"kid-s", file:"assets/images/shirt.png"},
            {id:"kid-n", file:"assets/images/noshirt.png"},
            {id:"board", file:"assets/images/board.png"},
            {id:"teacher", file:"assets/images/teacher.png"},

            {id:"wrong", file:"assets/images/wrong.png"},
            {id:"right", file:"assets/images/right.png"},

            {id:"tut1", file:"assets/images/tut-1.png"},
            {id:"tut2", file:"assets/images/tut-2.png"},
            {id:"tut3", file:"assets/images/tut-3.png"},
            {id:"tut4", file:"assets/images/tut-4.png"}
        ];
