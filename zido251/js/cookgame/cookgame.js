class CookGame {
    ...
    spawnBonusPos(indexPos) {
        ...
        if(indexPos == 0 ) {
            this.spawnBonusFood(this.getRandomBonusModel(), { x: 0, y: 500 }, { x: 550, y: -1000 }, 1200);
        }else if(indexPos == 1) {
            this.spawnBonusFood(this.getRandomBonusModel(), { x: 900, y: 500 }, { x: -550, y: -700 }, 1200);
        }else if(indexPos == 2) {
            this.spawnBonusFood(this.getRandomBonusModel(), { x: 300, y: 500 }, { x: 250, y: -1100 }, 1200);
        }
    }
