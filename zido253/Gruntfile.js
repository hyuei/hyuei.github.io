...
module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        concat: {
            ...
            dist: {
                src: files,
                dest: 'js/build/numbercalling_concat.min.js'
            }
        },
        uglify: {
            options: {
            ...
            build: {
                src: 'js/build/numbercalling_concat.min.js',
                dest: 'js/build/numbercalling_concat.min.js'
            }
        },
        copy: {
            main: {
                files: [
                    ...
                    {expand: true, src: ['js/build/numbercalling_concat.min.js'], dest:'build/'},
                    {expand: true, src: ['index_build_template.html'], dest:'build/',
                        rename: function(dest, src) {
                            return dest + 'index.html';
                        }
                    },
                    {expand: true, cwd: 'build', src: ['**'], dest:'../mirror-demo-server/public/games/numbercalling'}
                ]
            }
        }
