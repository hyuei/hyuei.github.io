...
ZidoConnect.prototype = {
    init:function(){        
    },

    setDomainTargetOrigins:function(domainTargetOriginArr){
        this.domainTargetOrigins = domainTargetOriginArr;
    },

    isInTargetOrigins:function(text){
    ...
    listenMessageEvent:function(onDataReceived)
    {
        console.log('listenMessageEvent')
        var ref = this;
    ...
    testDispatchEvent:function(isSuccess)
    {
