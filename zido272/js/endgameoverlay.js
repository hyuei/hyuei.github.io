class EndGameOverlay extends Phaser.Sprite
{
    ...
    createCharacter()
    {
        this.triocheers = this.game.add.sprite(0,0, 'endscreen', "trio-cheers");
    ...
    createScoreBox(){
        ...
        this.scoreBox = this.game.add.sprite(0,0, 'endscreen', "scorebox");
    ...
    createToobadTitle(){
        this.toobad = this.game.add.sprite(0,0, 'endscreen', "toobad");
    ...
    createCongratsTitle()
    {
        this.congratsTitle = this.game.add.sprite(0,0, 'endscreen', "congrats-title");
    ...
    {
        var ref = this;
        this.retryButton = this.game.add.button(0,0, 'btn-rety', ()=>{this.retryButtonDown();} );
