...
class PopupQuestion extends Phaser.Sprite
{
    ...
    init(){
        ...
        this.chooseOnePanel = this.game.add.image(0,0, 'uibox', 'ask-chooseone');
        this.chooseOnePanel.anchor.set(.5, .6);
        this.chooseOnePanel.y = this.y-440;
        //this.chooseOnePanel.x = this.x;
        let fx =  {font: "20px arial", fill: "#FFFFFF"};
        this.textChoose = this.game.add.text(0,0, STRINGS_DATA.data.chooseOne, fx);
        this.textChoose.anchor.set(.5, .6);
        this.chooseOnePanel.addChild(this.textChoose);
        this.chooseOnePanel.visible = false;
        ...
        let fontStle = {font: "20px arial", fill: "#000000"};
        ...
        this.addChild(this.chooseOnePanel);
        ...
        //scale Tween
        this.game.add.tween(this.boxGoodChoice.scale).to({x:1.05, y:1.05}, 800, Phaser.Easing.Linear.None, true, 0, -1, true);
        this.game.add.tween(this.boxBadChoice.scale).to({x:1.05, y:1.05}, 800, Phaser.Easing.Linear.None, true, 0, -1, true);
    }
    ...
    showQuestion(people, char){
        ...
        this.chooseOnePanel.visible = true;
