class Game1Screen extends GameScreen
{
    ...
    create()
    {
        ...
        this.numarray = [[605, 177], [461, 174], [329, 208], [355, 230], [260, 250], [296, 274], [376, 270], [390, 299], [689, 290], [650, 260], [699, 228], [615, 221]];
    ...
    createTalker()
    {
        ...
        this.talker.loadTalkingArray(TALKING_DATA.talkingdata.ImageLockOne);
