class Game4Screen extends GameScreen
{
    ...
    create()
    {
        ...
        this.numarray = [[284,127], [276,400], [416,424], [647, 363], [643, 302], [584, 258], [320,313], [316,237], [408, 207], [412, 251], [657, 197], [668,159], [561, 74], [348, 110]];
    ...
    createTalker()
    {
        ...
        this.talker.loadTalkingArray(TALKING_DATA.talkingdata.ImageLockFour);
