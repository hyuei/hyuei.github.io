class Game5Screen extends GameScreen
{
    ...
    create()
    {
        ...
        this.numarray = [[320,434], [452,259], [390,240],[360,209], [305,200], [321,168],[397,152],[422,177], [401,206], [461,216],[458,184], [437,142],[371,110], [516,93], [661,107], [603,203], [645,222], [591,263], [496,310], [548,441], [442,422], [360, 444]];
    ...
    createTalker()
    {
        ...
        this.talker.loadTalkingArray(TALKING_DATA.talkingdata.ImageLockFive);
