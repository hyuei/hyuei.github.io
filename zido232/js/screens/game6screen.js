class Game6Screen extends GameScreen
{
    ...
    create()
    {
        ...
        //house
        this.memoryChain.posdots = [[262, 293], [296, 158], [627,151], [623,104], [688,104], [680,155], [726,284], [296,291], [296, 326],[388,326], [386,401], [311,403], [306, 356], [271, 353], [275, 434], [425, 438], [427, 325], [552,324], [555, 433], [711,431], [714,311],[604, 315], [602,403], [679,404], [677, 334], [613, 334]];


        this.numarray = [[262, 293], [296, 158], [627,151], [623,104], [688,104], [680,155], [726,284], [296,291],[282, 326], [388,326], [386,401], [311,403], [306, 356], [271, 353], [275, 434], [425, 438], [427, 325], [552,324], [555, 433], [711,431], [714,311],[604, 315], [602,403], [679,404], [677, 334], [613, 334]];
    ...
    createTalker()
    {
        ...
        this.talker.loadTalkingArray(TALKING_DATA.talkingdata.End);
        this.talker.startTalk();

        this.talker.onNext.add(this.nextTalker, this);
        this.talker.onFinish.add(function(){
            //var score = Math.floor(this.cleanTeethGame.gameTimer);
            //this.endgameoverlay.setTextScore(this.cleanTeethGame.textTimer.text);
            var score = game.score;
            var time = this.memoryChain.updateTextTimer(game.timeElapsed);
            this.endgameoverlay.setTextScore(time);
