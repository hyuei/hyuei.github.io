class PreloadScreen {
    ...
    preload() {
        ...
        TALKING_DATA.loadAudios(game, TALKING_DATA.talkingdata.PopGame_Prolog);
        TALKING_DATA.loadAudios(game, TALKING_DATA.talkingdata.PopGame_End);
        TALKING_DATA.loadAudios(game, TALKING_DATA.talkingdata.PopGame_Fail);
